...
ivfflathandler(PG_FUNCTION_ARGS)
{
	...
	/* Interface functions */
	amroutine->ambuild = our_ivfflatbuild;
	amroutine->ambuildempty = our_ivfflatbuildempty;
	amroutine->aminsert = our_ivfflatinsert;
	amroutine->ambulkdelete = our_ivfflatbulkdelete;
...
#endif
    amroutine->ambeginscan = our_ivfflatbeginscan;
	amroutine->amrescan = our_ivfflatrescan;
	amroutine->amgettuple = our_ivfflatgettuple;
	amroutine->amgetbitmap = NULL;
	amroutine->amendscan = our_ivfflatendscan;
