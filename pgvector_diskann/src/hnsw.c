...
HnswInit(void)
{
	...
	DefineCustomIntVariable("hnsw.ef_search", "Sets the size of the dynamic candidate list for search",
							"Valid range is 1..2000.", &hnsw_ef_search,
...
hnswhandler(PG_FUNCTION_ARGS)
{
	...
	/* Interface functions */
	amroutine->ambuild = our_hnswbuild;
	amroutine->ambuildempty = our_hnswbuildempty;
	amroutine->aminsert = our_hnswinsert;
	amroutine->ambulkdelete = our_hnswbulkdelete;
	...
	amroutine->amrescan = our_hnswrescan;
	amroutine->amgettuple = our_hnswgettuple;
	amroutine->amgetbitmap = NULL;
	amroutine->amendscan = our_hnswendscan;
