...
// typedef struct {
//     Size mapping_size;
//     dsm_handle mapping_hdl;
// } SegmentUpdateResultData;
// typedef SegmentUpdateResultData* SegmentUpdateResult;
...
ResultSlot *vs_result_at(int pgprocno);
