...
// TODO: we need to update the delete ratio of the merged index
// Function to merge two built indices by inserting smaller index into larger one
extern "C" void
MergeTwoIndices(void *index1_ptr, uint8_t *bitmap1_ptr, int count1,
                void *index2_ptr, uint8_t *bitmap2_ptr, int count2,
