...
dsm_handle FaissIvfflatBuildAllocate(int dim, int nlist, void *vectors, uint64_t lowest_vid, uint64_t highest_vid, int vector_num, size_t *index_size, dsm_segment **return_index_seg);
...
dsm_handle FaissHnswIndexBuildAllocate(int dim, int M, int efConstruction, void *vectors, uint64_t lowest_vid, uint64_t highest_vid, int vector_num, size_t *index_size, dsm_segment **return_index_seg);
